...
import pl.javastart.components.category.CategoryController;
import pl.javastart.components.customer.CustomerController;
import pl.javastart.components.device.DeviceController;
import pl.javastart.components.device.DeviceRepository;
import pl.javastart.components.rent.RentController;

import java.util.Arrays;
import java.util.Scanner;

import static pl.javastart.app.Options.ADD_DEVICE;
