package pl.javastart.disolution.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Controller;
import pl.javastart.disolution.ConsoleOutputWriter;
import pl.javastart.disolution.model.Entry;
import pl.javastart.disolution.repository.EntryRepository;
...
public class LinguController {
    ...
    private void test() {
        ...
        Set<Entry> randomEntries = entryRepository.getRadnomEntries(testSize);
        int score = 0;
